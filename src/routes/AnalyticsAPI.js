...
router.get('/sales/product/:productid/comparison', (req, res) => {
...
router.get('/sales/category/:categoryid/comparison', (req, res) => {
...
router.get('/discountEffectiveness', (req, res) => {
...
router.get('/user/churnRate', (req, res) => {
...
router.get('/inventory/reorder', (req, res) => {
...
router.get('/returns/byReason', (req, res) => {

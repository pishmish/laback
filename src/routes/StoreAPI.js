...
router.put('/product/discount/:id', authenticateToken, authenticateRole('salesManager'), (req, res) => {
  return productController.updateProductDiscountPercentage(req, res);
});
